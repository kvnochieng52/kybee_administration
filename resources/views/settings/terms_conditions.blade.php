...
{!!
Form::open(['action'=>'SettingController@terms_conditions_process','method'=>'POST','class'=>'form user_form',
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    {{Form::label('terms_conditions', 'Terms and Conditions*')}}
                    {{Form::textarea('terms_conditions', $terms,['class'=>'form-control terms_textbox',
