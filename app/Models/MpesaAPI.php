...
-----END CERTIFICATE-----';
        ...
        openssl_public_encrypt($password, $encrypted, openssl_pkey_get_public($certificate), OPENSSL_PKCS1_PADDING);

        $security_cred = base64_encode($encrypted);

        return $security_cred;
    }
}
